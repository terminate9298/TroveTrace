...
<html>
	...
	<body class="right-sidebar">
		...
		?>
			<center>
			<img width="800px" src = "images/questions/wakanda_forever.jpg"></img>
			<!--<h2>The Game is currently offline. <?php //include("include/offline.php"); ?></h2>!-->
			<h3>What is spelling of W.K.N.A F.R.V.R ?></h3>

			<form action = "check.php" method="post">
				<input type="text" name="answer" id="answer"/>
				<input hidden type="text" name="ques" id ="ques" value="<?php echo $qid;?>"/>
				<input type="submit" class="button button-big button-icon button-icon-check" name="submit" value="Submit">
			</form>
      <?php
